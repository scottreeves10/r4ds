...
<span = class"emph"> Gather when a column name is actually a value, and cell values are actually variables (column names)</span>
...
<span class="emph">Spread when values of one column are acutally variables (column names), and their corresponding values are in some other column </span>

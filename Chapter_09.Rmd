...
1.  <span class="question">Compute the `rate` for `table2`, and `table4a` + `table4b`. You will need to perform four operations:</span>
    ...
    _I'll pass on this. Point taken. Tidy data is closely related to the idea of database normalization. Prefer to spend time proceeding with the productive ways to do things._ 

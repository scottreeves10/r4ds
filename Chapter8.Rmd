...
1.  What happens if you try and set `decimal_mark` and `grouping_mark` 
    ...
    Try and set `decimal_mark` and `grouping_mark` to the same character: - the fractional digits become part of the whole

```{r}
parse_number("123,456,789,28", locale = locale(grouping_mark = ","), (decimal_mark = ","))
```

   If `decimal_mark` is set to ",", then it appears `grouping_mark` is ignored.

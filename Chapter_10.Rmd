...
1.  <span class="question">Identify the keys in the following datasets</span>
    ...
    Note re: the output of `count()`: If the data already already has a column named n, the output column will be called nn. If the table already has columns called n and nn then the column returned will be nnn, and so on.

...
knitr::opts_chunk$set(comment = "#>",highlight=FALSE,collapse = TRUE,cache = TRUE,out.width = "70%",fig.align = 'center',fig.width = 6,fig.asp = 0.618)
...
1.  Brainstorm at least 5 different ways to assess the typical delay 
    ...
    * A flight is 15 minutes early 50% of the time, and 15 minutes late 50% of 
    ...
    ```{r}
    # First, I will simply a prototype against some logical numbers:
...
1.  Our definition of cancelled flights (`is.na(dep_delay) | is.na(arr_delay)`
    ...
    Alternate way to count na's by column: https://sebastiansauer.github.io/sum-isna/

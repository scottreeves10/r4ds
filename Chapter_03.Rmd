...
1.  Look at each destination. Can you find flights that are suspiciously
    ...
    Using the he 68–95–99.7 rule as a naive guideline, there are 19 out of 327,000 non-cancelled flights for which the recorded shortest air_time is outside the band of three standard deviations. 
...
1.  Find all destinations that are flown by at least two carriers. Use that
    ...
    # Destinations that are flown by at least two carriers - with mutate(). Use that
    # information to rank the carriers.
